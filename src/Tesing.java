...
public static void check_cities(String url, BufferedWriter BW_void, WebDriver driver) throws IOException, InterruptedException {
...
if (AllCityNumByZip_int4 == totalCity_int)  {
	...
	System.out.println("all listings splitted by cities test: passed "+AllCityNumByZip_int4+"=="+totalCity_int);
	//  BW_void.write("all listings splitted by cities test: passed "+AllCityNumByZip_int4+"=="+totalCity_int);
	                		     } 
        else 			{
        System.out.println("all listings splitted by cities test: failed "+AllCityNumByZip_int4+"!="+totalCity_int);
...
String url1 = ini.get("main settings", "url_sale", String.class);
driver.get(url1);
driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
...
String url2 = ini.get("main settings", "url_rent", String.class);
driver.get(url2);
driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
...
check_cities("http://www.realtyadvisorselite.com/homes-for-sale", BW2, driver);		
check_cities("http://www.realtyadvisorselite.com/apartments-for-rent", BW2, driver);
